...
<html lang="en">
  <head>
    ...
    <style>
      .body-color {
    background-color: rgb(194, 199, 243);
}
...
.text-success {
    font-weight: bold;
    color: #007bff; /* Change label color to a nice blue */
...
.btn-primary {
    padding: 12px 24px;
    background-color: #2855a7; /* Change button color to a nice green */
    color: #fff;
    border: none;
    border-radius: 6px;
    cursor: pointer;
      ...
      <form class="mr-auto py-5" method="post" action="/Rentsave" enctype="multipart/form-data">
        <div class="form-row">
          <div class="form-group col-md-6">
            ...
            <input type="Name" required class="form-control" name="Username" id="" placeholder="Username">
          </div>
          
          <div class="form-group col-md-6">
            <label for="phone_number " class="text-dark">Phone_number</label>
            <input type="text" required class="form-control" name="phone_number" placeholder="Phone_number">
          </div>
