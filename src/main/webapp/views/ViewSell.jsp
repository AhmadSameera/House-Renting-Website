    ...
    <%@ page import="java.util.List" %>
        ...
        <div class="card mb-3 ">
         <!-- jsp code for sellinghouse -->
              <% List<Sell> sellingList = (List<Sell>) request.getAttribute("ViewSell");
                if (sellingList != null && !sellingList.isEmpty()) {
                for (Sell sel : sellingList) {
            %>
           
        <div class="container-fluid bg-white rounded">
            <h1 class="text-dark text-center">Selling Details Of House
               <a style="align-items: end; margin-left: 50%;" href="/delete/ <%= sel.getId()%>">
                    <i style="color: red;" class="fas fa-trash"></i></a>
                </h1>
                <div class="form-row justify-content-center">
                    <div class="form-group col-md-3">
                        <label for="UserName" class="text-info">UserName</label>
                        <input type="Name" required class="form-control" readonly name="user_name" id=""
                            value="<%= sel.getUser_name() %>" placeholder="User-Name">
                    </div>
               
                    <div class="form-group col-md-3">
                        <label for="Phone" class="text-info">PhoneNumber</label>
                        <input type="text" required class="form-control" readonly name="Phone" value="<%= sel.getPhone() %>"
            ...
            <div class="rounded mx-auto d-block">
                <img height="380px" width="450px" src="data:image/*;base64,<%= sel.getImageBase64() %>" alt="House Image">
            </div>
            <hr class="my-4">
